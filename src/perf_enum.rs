...
pub enum PerfMetric {
    ...
    TotalMetricCount = 86,
    BlockCacheIndexHitCount = 1024,
    BlockCacheStandaloneHandleCount = 1025,
    BlockCacheRealHandleCount = 1026,
    IndexBlockReadCount = 1027,
    BlockCacheFilterHitCount = 1028,
    FilterBlockReadCount = 1029,
    CompressionDictBlockReadCount = 1030,
    BlockCacheIndexReadByte = 1031,
    BlockCacheFilterReadByte = 1032,
    BlockCacheCompressionDictReadByte = 1033,
    BlockCacheReadByte = 1034,
    SecondaryCacheHitCount = 1035,
    CompressedSecCacheInsertRealCount = 1036,
    CompressedSecCacheInsertDummyCount = 1037,
    CompressedSecCacheUncompressedBytes = 1038,
    CompressedSecCacheCompressedBytes = 1039,
    BlockDecompressCount = 1040,
    WriteSchedulingFlushesCompactionsTime = 1041,
    WriteThreadWaitNanos = 1042,
    GetCpuNanos = 1043,
    IterNextCpuNanos = 1044,
    IterPrevCpuNanos = 1045,
    IterSeekCpuNanos = 1046,
    IterNextCount = 1047,
    IterPrevCount = 1048,
    IterSeekCount = 1049,
    EncryptDataNanos = 1050,
    DecryptDataNanos = 1051,
    FileIngestionNanos = 1052,
    FileIngestionBlockingLiveWritesNanos = 1053,
    MultiscanPrepareCount = 1054,
    MultiscanBlocksPrefetched = 1055,
    MultiscanBlocksFromCache = 1056,
    MultiscanPrefetchBytes = 1057,
    MultiscanIoRequests = 1058,
    MultiscanIoCoalescedNonadjacent = 1059,
}

/// First discriminant served by `rust_rocksdb_perfcontext_metric_ext`, the
/// local C API extension covering perf-context fields that upstream's metric
/// enum lacks; smaller values go to upstream `rocksdb_perfcontext_metric`.
/// Must match the extension enum base in c_api_extensions.h.
const PERF_EXT_METRIC_BASE: u32 = 1024;

impl PerfMetric {
    /// Returns the name of this metric as it appears in RocksDB C++
    #[allow(clippy::too_many_lines)] // one generated match arm per metric
    pub const fn name(&self) -> &'static str {
        match self {
            ...
            PerfMetric::BlockCacheCompressionDictReadByte => "block_cache_compression_dict_read_byte",
            PerfMetric::BlockCacheFilterHitCount => "block_cache_filter_hit_count",
            PerfMetric::BlockCacheFilterReadByte => "block_cache_filter_read_byte",
            PerfMetric::BlockCacheIndexHitCount => "block_cache_index_hit_count",
            PerfMetric::BlockCacheIndexReadByte => "block_cache_index_read_byte",
            PerfMetric::BlockCacheReadByte => "block_cache_read_byte",
            PerfMetric::BlockCacheRealHandleCount => "block_cache_real_handle_count",
            PerfMetric::BlockCacheStandaloneHandleCount => "block_cache_standalone_handle_count",
            PerfMetric::BlockDecompressCount => "block_decompress_count",
            PerfMetric::CompressedSecCacheCompressedBytes => "compressed_sec_cache_compressed_bytes",
            PerfMetric::CompressedSecCacheInsertDummyCount => "compressed_sec_cache_insert_dummy_count",
            PerfMetric::CompressedSecCacheInsertRealCount => "compressed_sec_cache_insert_real_count",
            PerfMetric::CompressedSecCacheUncompressedBytes => "compressed_sec_cache_uncompressed_bytes",
            PerfMetric::CompressionDictBlockReadCount => "compression_dict_block_read_count",
            PerfMetric::DecryptDataNanos => "decrypt_data_nanos",
            PerfMetric::EncryptDataNanos => "encrypt_data_nanos",
            PerfMetric::FileIngestionBlockingLiveWritesNanos => "file_ingestion_blocking_live_writes_nanos",
            PerfMetric::FileIngestionNanos => "file_ingestion_nanos",
            PerfMetric::FilterBlockReadCount => "filter_block_read_count",
            PerfMetric::GetCpuNanos => "get_cpu_nanos",
            PerfMetric::IndexBlockReadCount => "index_block_read_count",
            PerfMetric::IterNextCount => "iter_next_count",
            PerfMetric::IterNextCpuNanos => "iter_next_cpu_nanos",
            PerfMetric::IterPrevCount => "iter_prev_count",
            PerfMetric::IterPrevCpuNanos => "iter_prev_cpu_nanos",
            PerfMetric::IterSeekCount => "iter_seek_count",
            PerfMetric::IterSeekCpuNanos => "iter_seek_cpu_nanos",
            PerfMetric::MultiscanBlocksFromCache => "multiscan_blocks_from_cache",
            PerfMetric::MultiscanBlocksPrefetched => "multiscan_blocks_prefetched",
            PerfMetric::MultiscanIoCoalescedNonadjacent => "multiscan_io_coalesced_nonadjacent",
            PerfMetric::MultiscanIoRequests => "multiscan_io_requests",
            PerfMetric::MultiscanPrefetchBytes => "multiscan_prefetch_bytes",
            PerfMetric::MultiscanPrepareCount => "multiscan_prepare_count",
            PerfMetric::SecondaryCacheHitCount => "secondary_cache_hit_count",
            PerfMetric::WriteSchedulingFlushesCompactionsTime => "write_scheduling_flushes_compactions_time",
...
impl PerfMetric {
    /// Every metric except the `TotalMetricCount` sentinel, in discriminant order.
    pub const ALL: &[PerfMetric] = &[
        ...
        PerfMetric::ReadIndexBlockNanos,
        PerfMetric::ReadFilterBlockNanos,
        PerfMetric::NewTableBlockIterNanos,
        PerfMetric::NewTableIteratorNanos,
        PerfMetric::BlockSeekNanos,
        PerfMetric::FindTableNanos,
        PerfMetric::BloomMemtableHitCount,
        PerfMetric::BloomMemtableMissCount,
        PerfMetric::BloomSstHitCount,
        PerfMetric::BloomSstMissCount,
        PerfMetric::KeyLockWaitTime,
        PerfMetric::KeyLockWaitCount,
        PerfMetric::EnvNewSequentialFileNanos,
        PerfMetric::EnvNewRandomAccessFileNanos,
        PerfMetric::EnvNewWritableFileNanos,
        PerfMetric::EnvReuseWritableFileNanos,
        PerfMetric::EnvNewRandomRwFileNanos,
        PerfMetric::EnvNewDirectoryNanos,
        PerfMetric::EnvFileExistsNanos,
        PerfMetric::EnvGetChildrenNanos,
        PerfMetric::EnvGetChildrenFileAttributesNanos,
        PerfMetric::EnvDeleteFileNanos,
        PerfMetric::EnvCreateDirNanos,
        PerfMetric::EnvCreateDirIfMissingNanos,
        PerfMetric::EnvDeleteDirNanos,
        PerfMetric::EnvGetFileSizeNanos,
        PerfMetric::EnvGetFileModificationTimeNanos,
        PerfMetric::EnvRenameFileNanos,
        PerfMetric::EnvLinkFileNanos,
        PerfMetric::EnvLockFileNanos,
        PerfMetric::EnvUnlockFileNanos,
        PerfMetric::EnvNewLoggerNanos,
        PerfMetric::NumberAsyncSeek,
        PerfMetric::BlobCacheHitCount,
        PerfMetric::BlobReadCount,
        PerfMetric::BlobReadByte,
        PerfMetric::BlobReadTime,
        PerfMetric::BlobChecksumTime,
        PerfMetric::BlobDecompressTime,
        PerfMetric::InternalRangeDelReseekCount,
        PerfMetric::BlockReadCpuTime,
        PerfMetric::InternalMergePointLookupCount,
        PerfMetric::DataBlockReadByte,
        PerfMetric::IndexBlockReadByte,
        PerfMetric::FilterBlockReadByte,
        PerfMetric::CompressionDictBlockReadByte,
        PerfMetric::MetadataBlockReadByte,
        PerfMetric::BlobCacheReadByte,
